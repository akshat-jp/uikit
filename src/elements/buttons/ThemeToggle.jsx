...
export function ThemeToggle({setDarkMode, darkMode}){
    ...
    return (
        <button className={`${theme==="dark" ? "hover:bg-neutral-900 border-neutral-700" : "hover:bg-neutral-300 border-neutral-500"} transition duration-300 cursor-pointer relative flex items-center justify-center  border  rounded-md size-10` } onClick={() => {setTheme(theme === "dark" ? "light" : "dark"); setDarkMode(!darkMode)}}>
